...
class ConsoleWarningOverlay(QtWidgets.QWidget):
    ...
    def __init__(self, parent):
        ...
        style_sheet = (
            self.STYLESHEET_DARK if ColorScheme.dark_scheme else self.STYLESHEET
        )
    ...
    def __init__(self, wallet, prompt=">> ", startup_message="", parent=None):
        ...
        if not config_dontaskagain:
            ...
            def on_acknowledged(dontaskagain: bool):
                wallet_storage.put(
                    self.CONFIG_DONTASKAGAIN_KEY, dontaskagain or None
    ...
    def runCommand(self):
        ...
        if command:
            ...
            try:
                ...
                # Catch errors in the network layer as well
