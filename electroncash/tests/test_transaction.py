...
class TestTransaction(unittest.TestCase):
    ...
    def test_txid_p2pk_to_p2pkh(self):
        ...
        self.assertEqual(
            "90ba90a5b115106d26663fce6c6215b8699c5d4b2672dd30756115f3337dddf9",
            tx.txid(),
        )
    ...
    def test_txid_p2pkh_to_p2sh(self):
        ...
        self.assertEqual(
            "155e4740fa59f374abb4e133b87247dccc3afc233cb97c2bf2b46bba3094aedc",
            tx.txid(),
        )
    ...
    def test_txid_p2sh_to_p2pkh(self):
        ...
        self.assertEqual(
            "0ea982e8e601863e604ef6d9acf9317ae59d3eac9cafee6dd946abadafd35af8",
            tx.txid(),
        )
    ...
    def test_parse_output_p2pk_badpubkey(self):
        ...
        self.assertEqual(
            "8e57f026081b6589570dc5e6e339b706d2ac75e6cbd1896275dee176b8d35ba6",
            tx.txid(),
        )
    ...
    def test_parse_output_p2pk_uncomp_badpubkey(self):
        ...
        self.assertEqual(
            "a15a9f86f5a47ef7efc28ae701f5b2a353aff76a21cb22ff08b77759533fb59b",
            tx.txid(),
        )
    ...
    def test_parse_output_truncated1(self):
        ...
        self.assertEqual(
            "72d8af8edcc603c6c64390ac5eb913b97a80efe0f5ae7c00ad5397eb5786cd33",
            tx.txid(),
        )
